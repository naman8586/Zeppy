...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { confirmPassword, name, phone, ...rest } = formData;
      ...
      setError(
        err.response?.data?.message || "ENROLLMENT_FAILED: Database rejection.",
      );
    } finally {
      setLoading(false);
    }
        ...
        <div className="bg-zinc-950 border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl backdrop-blur-xl">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-bold tracking-tighter uppercase italic">
              ZAPPY
              <span className="text-zinc-500 font-black not-italic">_</span>
              ENROLL
            </h1>
          ...
          <div className="mt-10 pt-6 border-t border-white/5 text-center">
            <p className="text-zinc-500 text-[10px] uppercase tracking-widest">
              ...
              <Link
                href="/login"
                className="text-white hover:text-zinc-400 font-bold transition-colors"
              >
                Return_To_Login
              </Link>
            </p>
